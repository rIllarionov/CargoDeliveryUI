...
public class BoxController : MonoBehaviour
{
    ...
    private bool _boxOnFinish;
    private RopeController _ropeController;

    private void Awake()
    {
        _ropeController = _rope.GetComponentInParent<RopeController>();
    ...
    private void OnCollisionEnter()
    {
        ...
        _ropeController.MoveIsFinish(_boxOnFinish);
    }
    ...
    {
        _ropeController.BoxOnTheGround();
        _boxOnFinish = true;
